import { LayoutDashboard, Users, TrendingUp, DollarSign, UserPlus, FileText, LogOut, Bell, AlertCircle, UserCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-gray-900">Master Admin Dashboard</h1>
                <p className="text-gray-600 text-sm">Share Claim CRM System</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex gap-4 mb-8">
          ...
          <Button variant="outline" onClick={() => onNavigate('manage-users')}>
            <Users className="w-4 h-4 mr-2" />
            Manage Users (RM/Field Boy)
          </Button>
          <Button variant="outline" onClick={() => onNavigate('all-cases')}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-gray-900">247</div>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-600">Total Value Recovering</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-gray-900">₹4.8 Cr</div>
                <div className="bg-green-100 p-3 rounded-lg">
                  <TrendingUp className="w-6 h-6 text-green-600" />
                </div>
              </div>
              <p className="text-green-600 text-sm mt-2">Expected value</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-600">Money Received</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-gray-900">₹2.3 Cr</div>
                <div className="bg-purple-100 p-3 rounded-lg">
                  <DollarSign className="w-6 h-6 text-purple-600" />
                </div>
              </div>
              <p className="text-gray-600 text-sm mt-2">47.9% recovered</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-600">Total Expenditure</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-gray-900">₹18.5 L</div>
                <div className="bg-orange-100 p-3 rounded-lg">
                  <DollarSign className="w-6 h-6 text-orange-600" />
                </div>
              </div>
              <p className="text-gray-600 text-sm mt-2">Operational costs</p>
            </CardContent>
          </Card>
        </div>
